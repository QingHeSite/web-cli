...
log(chalk$3.blue('start') + ' install' + chalk$3.red('!'));
console.log(process$5.cwd());
program
...
// 	spinner.succeed('成功')
// })
console.log('path---', { path1: path$1.join(process$5.cwd(), dirName), path2: path$1.resolve(__dirname, '') });
const targetPath = path$1.join(process$5.cwd(), dirName);
execSync(`git clone git@gitlab.feeyo.com:cfrontend/frontend-template.git ${targetPath}`, {
    stdio: [0, 1, 2], // we need this so node will print the command output
});
process$5.chdir(targetPath);
// 删除指定文件夹
const dirToDelete = path$1.join(targetPath, '.git');
require$$0$9.rmSync(dirToDelete, { recursive: true, force: true }); // 递归删除文件夹及其内容
